...
class OpenAlexClient:
    ...
    def get_content(
        ...
        *,
        ...
        """Download a full-text artifact and return it as text.

        Content lives on content.openalex.org rather than the API host, and
        two things about it catch a naive client out. It is billed at the
        content rate, currently $0.01, which is a hundred times a list call.
        And it arrives gzipped under ``Content-Type: application/gzip`` rather
